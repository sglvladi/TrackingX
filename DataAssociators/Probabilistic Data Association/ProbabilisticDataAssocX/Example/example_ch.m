...
% Generate DataList
[DataList,x1,y1] = gen_obs_cluttered_multi2(NumTracks, x_true, y_true, sqrt(obs.ObsErrVariance), [0 10 0 10], 20, 1);
...
for i=1:NumTracks
    ...
    TrackList{i}.Filter = ParticleFilterX(ssm);
...
Params_pdaf.Gater = EllipsoidalGaterX(2,'ProbOfGating',0.9)';
