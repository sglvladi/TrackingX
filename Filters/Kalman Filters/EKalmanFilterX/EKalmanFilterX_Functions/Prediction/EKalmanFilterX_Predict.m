function [xPred, PPred, yPred, S, Pxy, F, H, B] = EKalmanFilterX_Predict(x,P,f,Q,h,R,u,b,Qu)
...
% October 2017 Lyudmil Vladimirov, University of Liverpool.
   ...
   [xPred,PPred,F,B]  = EKalmanFilterX_PredictState(x,P,f,Q,u,b,Qu);
   [yPred,S,Pxy,H]    = EKalmanFilterX_PredictObs(xPred,PPred,h,R);
end