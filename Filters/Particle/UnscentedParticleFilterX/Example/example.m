...
upf.initialise('PriorDistFcn',@(N)deal(mvnrnd(xPrior(:,ones(1,N))',PPrior)',1/N*ones(1,N)));
...
for t = 1:NumIter
    ...
    upf.Measurement = measurements(:,t);
    ...
    % Log the data
    Log.Estimates.StateMean(:,t) = upf.StateMean;
    Log.Estimates.StateCovar(:,:,t) = upf.StateCovar;
