...
epf = ExtendedParticleFilterX(ssm);
...
epf.initialise('PriorDistFcn',@(N)deal(mvnrnd(xPrior(:,ones(1,N))',PPrior)',1/N*ones(1,N)));
...
for t = 1:NumIter
    ...
    epf.Measurement = measurements(:,t);
    ...
    % Log the data
    Log.Estimates.StateMean(:,t) = epf.StateMean;
    Log.Estimates.StateCovar(:,:,t) = epf.StateCovar;
