...
kf.initialise('PriorStateMean',xPrior,'PriorStateCov',PPrior); 
...
for t = 1:NumIter
    ...
    % Log the data
    Log.Estimates.StateMean(:,t) = kf.StateMean;
    Log.Estimates.StateCovar(:,:,t) = kf.StateCovar;
