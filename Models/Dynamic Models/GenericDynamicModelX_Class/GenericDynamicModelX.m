classdef GenericDynamicModelX <  DynamicModelX % Handle class with copy functionality
    % GenericDynamicModelX class
    %
    % Summary of GenericDynamicModelX
    ...
    methods
        function this = GenericDynamicModelX(Init)
        % GENERICDYNAMICMODELX Constructor method
        %   
