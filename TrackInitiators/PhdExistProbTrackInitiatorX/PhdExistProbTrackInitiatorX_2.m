classdef PhdExistProbTrackInitiatorX_2 < TrackInitiatorX 
% PhdExistProbTrackInitiatorX_2 Abstract class
%
% Summary of PhdExistProbTrackInitiatorX_2:
% This is the base class for all TrackingX resamplers.
% Any custom defined Track Initiator should be derived from this PhdExistProbTrackInitiatorX_2 base class. 
%
...
% March 2018 Lyudmil Vladimirov, University of Liverpool.
    ...
    methods
        function this = PhdExistProbTrackInitiatorX_2(varargin)
        % PHDEXISTPROBTRACKINITIATORX Constructor method
        %   
        % DESCRIPTION: 
        % * PhdExistProbTrackInitiatorX_2('PHDFilter',PHDFilter,'ProbOfGating',ProbOfGating) 
        %   returns a PhdExistProbTrackInitiatorX_2 object handle configured with the provided
...
%                 TrackList{trackInd}.ProbOfExist = (sum(this.AssocWeightsMatrix(trackInd,:))*TrackList{trackInd}.ProbOfExist)/denom;
            ...
            this.pi = p_i;
            this.measLik = measLikelihood(:,idx);
            this.w_ni = w_ni(:,idx);
        end 
    end
end