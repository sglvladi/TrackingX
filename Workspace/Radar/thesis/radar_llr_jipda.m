...
VideoPathName = strcat(RadarName,'_llr.avi'); % Set to the desired path and name of produced recording
...
%     pause(0.01);
    ...
    [TrackList, ~, del_tracks] = myti.initiateTracks(jpdaf.TrackList, MeasurementList, jpdaf.AssocWeightsMatrix, jpdaf.LikelihoodMatrix);
