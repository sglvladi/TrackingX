...
config.Gater = EllipsoidalGaterX(2,'GateLevel',20)';
...
%% Track Deleter
config_td = struct('DeleteThreshold', seconds(20));
mytd = TimeBasedDeleterX(config_td);
...
%     pause(0.01);
    ...
    TrackList = mytd.deleteTracks(TrackList, timestamp_k);
