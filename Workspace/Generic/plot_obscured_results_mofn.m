...
% rectangle(ax(1), 'Position', pos, 'LineWidth', 2, 'EdgeColor', 'c');
x = [-4.166323663961963,-4.166170581070658,-4.163614096785874,-4.163813104544570, -4.166323663961963,];
y = [50.356012752715735,50.355690456249540,50.356208083907370,50.356530380373560, 50.356012752715735];
...
legend([h1, h3, h5, h6, h7, h8, h9], 'Detections', 'Obscured Region', 'Track Birth', 'Track Death', 'Fragmentation Examples', 'Jump Track', 'Bonus Tracks','Location','southeast');
% legend([h1, h2, h3, h4], 'Detections', 'Radar Position', 'Obscured Region', 'High-clutter region');
% xlabel('Longitude');
% ylabel('Latitude');
set(ax(1),'YTickLabel',[]);
