...
V = 360*180;     % Volume of surveillance region (10x10 2D-grid)
V_bounds = [-180 180 -90 90]; % [x_min x_max y_min y_max]
...
%% Generate DataList
config_det.Filename = "C:\Users\sglvladi\Documents\GitHub\Stone-Soup-TA\examples\track_analytics\data\exact_earth\exactEarth_historical_data_2017-08-10.csv";
config_det.StateFields = {'Longitude', 'Latitude'};
config_det.TimeField = 'Time';
config_det.TimeFormat = 'yyyyMMdd_HHmmss';
config_det.TimeZone = 'UTC';
% detector = CsvMeasurementReaderX(config_det);
...
TrackList = [];
DataList = MeasurementListX.empty();
N = 10000;
for k=2:N
    fprintf('Iteration = %d/%d\n================>\n',k,N);
    
    %% Extract DataList at time k
    DataList(k) = detector.read();
